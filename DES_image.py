...
def encrypt_image(data,key,outFile):
    ...
    for i in range(bv.length()// 64):
        ...
        final_cypher = RE+LE
        final_cypher.write_to_file(outF)
    return 
...
outF.writelines([Header1,Header2,Header3])
encrypt_image(data,key,outF)
